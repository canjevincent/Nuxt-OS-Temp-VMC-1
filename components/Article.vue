      ...
      <div class="flex flex-col justify-center">
        <div class="max-w-xl mb-6">
          <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
            Simplicity is the<br class="hidden md:block" />
            ultimate
            <span class="relative px-1">
              <div class="absolute inset-x-0 bottom-0 h-3 transform -skew-x-12 bg-blue-400"></div>
              <span class="relative inline-block text-purple-700">sophistication.</span>
            </span>
          </h2>
        ...
        <div class="grid gap-5 row-gap-8 sm:grid-cols-2">
          <div class="bg-white border-l-4 shadow-sm border-blue-400">
