...
<template>
  <footer class="relative mt-16 bg-blue-600">
    <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-blue-600" preserveAspectRatio="none" viewBox="0 0 1440 54">
    ...
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        <div class="md:max-w-md lg:col-span-2">
          <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
            <img src="/vmc.png" alt="logo" class="cursor-point rounded-md shadow-sm h-[50px]">
      ...
      <div class="flex flex-col justify-between pt-5 pb-10 border-t border-purple-200 sm:flex-row">
        ...
        <div class="flex items-center mt-4 space-x-4 sm:mt-0">
          <a href="/" class="transition-colors duration-300 text-deep-purple-100 hover:text-teal-400">
